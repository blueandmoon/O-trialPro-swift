...
class ChartHeaderView: UICollectionReusableView {
    ...
    func configUI() {
        ...
        hLine.backgroundColor = UIColor(hexString: OT_Light_Yellow)
        _ = hLine.sd_layout().rightEqualToView(self)?.widthIs(20)?.heightIs(1)?.bottomSpaceToView(self, k_chartBottomSpace)
        
        let vLine = UIView()
        self.addSubview(vLine)
        vLine.backgroundColor = UIColor(hexString: OT_Light_Yellow)
        ...
        node1.backgroundColor = UIColor(hexString: OT_Light_Yellow)
        ...
        nodeOne?.textColor = UIColor(hexString: OT_Light_Yellow)
        ...
        node2.backgroundColor = UIColor(hexString: OT_Light_Yellow)
        ...
        nodeTwo?.textColor = UIColor(hexString: OT_Light_Yellow)
        ...
        node3.backgroundColor = UIColor(hexString: OT_Light_Yellow)
        ...
        nodeThree?.textColor = UIColor(hexString: OT_Light_Yellow)
        ...
        nodeZero.textColor = UIColor(hexString: OT_Light_Yellow)
