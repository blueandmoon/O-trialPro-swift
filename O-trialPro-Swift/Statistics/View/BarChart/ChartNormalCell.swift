...
//        nameLbl?.layer.borderWidth = 1
        ...
        nameLbl?.textColor = HexColor(OT_Light_Yellow)
        _ = nameLbl?.sd_layout().leftSpaceToView(contentView, 1)?.rightSpaceToView(contentView, 1)?.heightIs(15)?.bottomSpaceToView(contentView, 5)
        
        let line = UIView()
        contentView.addSubview(line)
        line.backgroundColor = HexColor(OT_Light_Yellow)
        ...
        lump?.backgroundColor = HexColor(OT_Light_Yellow)
        ...
        numLbl?.textColor = HexColor(OT_Light_Yellow)
